class Port{
    ...
    connecting(evt){
        ...
        function mouseup() {
            ...
            let from = triangle1.attr("model");
            let to = d3.select(selection).attr("model");
            let r = new Connection(websimgui.boxes[from], websimgui.boxes[to], websimgui.svgContainer);
            r.updatePosition();
        }
